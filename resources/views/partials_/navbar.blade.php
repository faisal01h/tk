<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
    <a href="{{ url('/') }}" class="navbar-brand d-flex align-items-center">
        <h2 class="m-0 text-primary"><img class="img-fluid me-2" src="{{ asset('img/logo-tk-al-quran-jember.png') }}" alt=""
                style="width: 45px;">TK Ilmu Al-Qur'an</h2>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-4 py-lg-0">
            <a href="#misi" class="nav-item nav-link">Misi</a>
            <a href="#unggulan" class="nav-item nav-link">Program</a>
